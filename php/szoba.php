...
<body>
    ...
    <script>
        ...
        function fetchGuests() {
            ...
            xhr.open("GET", `../API/api.php?action=getGuests&roomCode=${roomCode}`, true);
        ...
        window.onload = function () {
            ...
            // Ellenőrizzük, hogy van ilyen szoba a Firebase adatbázisban
        ...
        function checkRoomCreator(roomCode) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", `../API/api.php?action=getRoomCreator&roomCode=${roomCode}`, true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
